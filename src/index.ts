    ...
    */
    ...
    function calculateTask2A(){
        let input      = parseInt((document.getElementById('input-2-a') as HTMLInputElement).value);
    ...
    */
    ...
    function calculateTask2B(){
        let input      = parseInt((document.getElementById('input-2-b') as HTMLInputElement).value);
    ...
    */
    ...
    function calculateTask2C(){
        ...
        let input      = parseInt((document.getElementById('input-2-c') as HTMLInputElement).value);
